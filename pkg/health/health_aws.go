...
var awsResourceHealthmap = map[string]map[string]HealthStatus{
	AWSResourceTypeCloudformationStack: {
		...
		"import_rollback_complete":                     HealthStatus{Status: HealthStatusRolledBack, Health: HealthWarning, Ready: true},
		"import_rollback_failed":                       HealthStatus{Status: HealthStatusError, Health: HealthUnhealthy, Ready: true},
		"import_rollback_in_progress":                  HealthStatus{Status: HealthStatusRollingBack, Health: HealthWarning},
		"review_in_progress":                           HealthStatus{Status: HealthStatusReviewing, Health: HealthUnknown},
		"rollback_complete":                            HealthStatus{Status: HealthStatusRolledBack, Health: HealthWarning, Ready: true},
		"rollback_failed":                              HealthStatus{Status: HealthStatusError, Health: HealthUnhealthy, Ready: true},
		"rollback_in_progress":                         HealthStatus{Status: HealthStatusRollingBack, Health: HealthWarning},
		...
		"update_rollback_complete":                     HealthStatus{Status: HealthStatusRolledBack, Health: HealthWarning Ready: true},
		"update_rollback_failed":                       HealthStatus{Status: HealthStatusError, Health: HealthUnhealthy, Ready: true},
		"update_rollback_in_progress":                  HealthStatus{Status: HealthStatusRollingBack, Health: HealthWarning},
	},
